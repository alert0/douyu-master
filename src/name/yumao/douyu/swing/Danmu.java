...
public class Danmu extends JFrame implements ActionListener{
	...
	private JLabel titleLabel=new JLabel("斗鱼TV评论小助手0907");
	...
	private JLabel supLabel=new JLabel("陈一发儿(67373)");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == butnSure) {
			...
			// 获取登入服务器列表
			//List<DouyuApiServersVo> loginServerList = HttpClientFromDouyu.QueryDouyuDownloadUrl(inNum.getText() , Config.cdn).getServers() ;
			// 开始启动登入Mina线程
