...
public class DouyuApiDataVo implements Serializable{
	/**
	 * 
	 */
...
//	private List<DouyuApiBitrateVo> rtmp_multi_bitrate;
	private String owner_avatar;
	private List<DouyuApiServersVo> servers;
	...
	public List<DouyuApiServersVo> getServers() {
		return servers;
	}
	public void setServers(List<DouyuApiServersVo> servers) {
...
@Override
	public String toString() {
		...
		builder.append("DouyuApiDataVo [room_id=");
		builder.append(room_id);
		builder.append(", room_src=");
		builder.append(room_src);
		builder.append(", cate_id=");
		builder.append(cate_id);
		builder.append(", tags=");
		builder.append(tags);
		builder.append(", room_name=");
		builder.append(room_name);
		builder.append(", vod_quality=");
		builder.append(vod_quality);
		builder.append(", show_status=");
		builder.append(show_status);
		builder.append(", subject=");
		builder.append(subject);
		builder.append(", show_time=");
		builder.append(show_time);
		builder.append(", owner_uid=");
		builder.append(owner_uid);
		builder.append(", specific_catalog=");
		builder.append(specific_catalog);
		builder.append(", specific_status=");
		builder.append(specific_status);
		builder.append(", online=");
		builder.append(online);
		builder.append(", nickname=");
		builder.append(nickname);
		builder.append(", show_details=");
		builder.append(show_details);
		builder.append(", url=");
		builder.append(url);
		...
		builder.append(", fans=");
		builder.append(fans);
		builder.append(", rtmp_url=");
		builder.append(rtmp_url);
		builder.append(", rtmp_live=");
		builder.append(rtmp_live);
		builder.append(", rtmp_cdn=");
		builder.append(rtmp_cdn);
		builder.append(", owner_avatar=");
		builder.append(owner_avatar);
		builder.append(", servers=");
		builder.append(servers != null ? servers.subList(0, Math.min(servers.size(), maxLen)) : null);
		builder.append(", owner_weight=");
		builder.append(owner_weight);
		builder.append(", use_p2p=");
		builder.append(use_p2p);
		builder.append(", hls_url=");
		builder.append(hls_url);
		builder.append("]");
