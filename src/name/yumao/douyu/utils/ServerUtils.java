...
public class ServerUtils {
	...
	public static DouyuApiDataVo QueryDouyuDownloadUrl(String roomApiStr) throws Exception {
		  ...
		  return roomApiVo.getData() ; //.getRtmp_url() + "/" + roomApiVo.getData().getRtmp_live();
	} 
