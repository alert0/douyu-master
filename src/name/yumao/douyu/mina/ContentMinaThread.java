...
//
//	            if(message.equals("end" + inNum.getText() ) ) {
//	             	connector.dispose();
//	            }
//	           // this.msg = message;
//
...
//
//		while( true &&  Config.TIMEOUT != -1) {
//            java.util.Calendar c2=java.util.Calendar.getInstance();
//
//            if(Config.TIMEOUT != -1 &&  (c2.getTime().getTime() - c1.getTime().getTime()) > 60 * 1000 * Config.TIMEOUT ) {
//            	connector.dispose();
//            	break;
//            }
//
